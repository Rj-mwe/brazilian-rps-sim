...
# Alias global para o nome legado brazilian_rps_sim
sys.modules["brazilian_rps_sim"] = sys.modules[__name__]
sys.modules["brazilian_rps_sim.core"] = sys.modules.get(__name__ + ".core")
sys.modules["brazilian_rps_sim.adapters"] = sys.modules.get(__name__ + ".adapters")
sys.modules["brazilian_rps_sim.infrastructure"] = sys.modules.get(__name__ + ".infrastructure")
