...
def build_world_and_markers(context, *args, **kwargs):
    ...
    try:
        from rps_br.adapters.gazebo import (
...
def generate_launch_description():
    ...
    focus_candidates = [
        os.path.join(os.path.dirname(os.path.dirname(pkg_share)), 'lib', 'rps_br', 'camera_auto_focus.py'),
        '/home/rjgamito/ros2_ws/install/rps_br/lib/rps_br/camera_auto_focus.py',
        '/home/rjgamito/ros2_ws/src/rps_br/rps_br/adapters/gazebo/camera_auto_focus.py',
        os.path.join(pkg_share, '..', '..', 'src', 'rps_br', 'rps_br', 'adapters', 'gazebo', 'camera_auto_focus.py'),
        '/home/rjgamito/ros2_ws/src/rps_br/rps_br/tools/camera_auto_focus.py',
    ]
