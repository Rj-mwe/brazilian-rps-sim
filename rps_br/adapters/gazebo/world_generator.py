...
try:
    from rps_br.adapters.shared.color_palette import resolve_color
except ImportError:
...
def generate_world_sdf(config_path: str = None, output_path: str = None):
    if not config_path or not os.path.exists(config_path):
        try:
            ...
            pkg_share = get_package_share_directory('rps_br')
    ...
    if not config_path or not os.path.exists(config_path):
        ...
        if os.path.exists(candidate):
            ...
            config_path = '/home/rjgamito/ros2_ws/src/rps_br/config/simulation_parameters.yaml'
    ...
    if not output_path:
        if config_path and os.path.exists(config_path):
            ...
            output_path = '/home/rjgamito/ros2_ws/src/rps_br/worlds/solar_system_brazilian_rps.sdf'
    ...
    <model name="celestial_skydome">
      ...
      <link name="starfield_link">
        <visual name="v_stars">
          ...
          <geometry>
            <mesh>
              <uri>package://rps_br/meshes/celestial_skydome.glb</uri>
            </mesh>
          </geometry>
        </visual>
      </link>
      ...
      <link name="sun_link">
        <visual name="sun_photosphere">
          ...
          <material>
            ...
            <pbr>
              <metal>
                <albedo_map>package://rps_br/materials/textures/sun_photosphere_2k.jpg</albedo_map>
                <emissive_map>package://rps_br/materials/textures/sun_photosphere_2k.jpg</emissive_map>
    ...
    <model name="earth_orbit_trail">
      ...
      <link name="trail_link">
        <visual name="v_earth_orbit_ring">
          <cast_shadows>false</cast_shadows>
          <geometry>
            <mesh><uri>package://rps_br/meshes/earth_orbit_ring.gltf</uri></mesh>
          </geometry>
          <material>
    ...
    <model name="earth">
      ...
      <link name="earth_link">
        ...
        <visual name="earth_surface">
          ...
          <geometry>
            <mesh>
              <uri>package://rps_br/meshes/earth_globe.glb</uri>
            </mesh>
          </geometry>
          <material>
            ...
            <pbr>
              <metal>
                <albedo_map>package://rps_br/materials/textures/earth_day_albedo_2k.jpg</albedo_map>
                <emissive_map>package://rps_br/materials/textures/earth_night_lights_2k.jpg</emissive_map>
        ...
        <visual name="earth_clouds">
          ...
          <geometry>
            <mesh>
              <uri>package://rps_br/meshes/earth_clouds.glb</uri>
            </mesh>
          </geometry>
          <material>
            <diffuse>1.0 1.0 1.0 1.0</diffuse>
            <pbr>
              <metal>
                <albedo_map>package://rps_br/materials/textures/earth_clouds_2k.png</albedo_map>
      ...
      <link name="moon_link">
        ...
        <visual name="moon_surface">
          ...
          <material>
            ...
            <pbr>
              <metal>
                <albedo_map>package://rps_br/materials/textures/moon_day_albedo_2k.jpg</albedo_map>
                <normal_map>package://rps_br/materials/textures/moon_normal_2k.jpg</normal_map>
                <roughness>0.9</roughness>
                <metalness>0.0</metalness>
              </metal>
            </pbr>
    ...
    <model name="moon_orbit_trail">
      ...
      <link name="moon_trail_link">
        <visual name="v_moon_orbit_ring">
          <cast_shadows>false</cast_shadows>
          <geometry>
            <mesh><uri>package://rps_br/meshes/moon_orbit_ring.gltf</uri></mesh>
          </geometry>
          <material>
    ...
    <model name="constellation_orbit_geo">
      ...
      <link name="geo_ring_link">
        <visual name="v_orbit_geo">
          <cast_shadows>false</cast_shadows>
          <geometry>
            <mesh><uri>package://rps_br/meshes/orbit_geo.gltf</uri></mesh>
          </geometry>
          <material>
    ...
    <model name="constellation_orbit_igso">
      ...
      <link name="igso_ring_link">
        <visual name="v_orbit_igso">
          <cast_shadows>false</cast_shadows>
          <geometry>
            <mesh><uri>package://rps_br/meshes/orbit_igso.gltf</uri></mesh>
          </geometry>
          <material>
    ...
    <model name="{model_name}">
      ...
      <link name="{model_name}_link">
        ...
        <visual name="v_satellite_pbr">
          ...
          <geometry>
            <mesh>
              <uri>package://rps_br/meshes/satellite_navsat.glb</uri>
...
"""
        ...
        <visual name="v_locator_ring">
          ...
          <geometry>
            <mesh>
              <uri>package://rps_br/meshes/locator_ring_{type_lower}.glb</uri>
            </mesh>
          </geometry>
          <material>
...
"""
        ...
        <visual name="v_nadir_cage">
          ...
          <geometry>
            <mesh>
              <uri>package://rps_br/meshes/nadir_cage_{type_lower}.glb</uri>
            </mesh>
          </geometry>
          <material>
...
"""
        ...
        <visual name="v_nadir_boresight">
          ...
          <geometry>
            <mesh>
              <uri>package://rps_br/meshes/nadir_boresight_{type_lower}.glb</uri>
            </mesh>
          </geometry>
          <material>
